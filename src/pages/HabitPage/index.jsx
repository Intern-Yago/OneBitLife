...
export default function HabitPage({route}){
    ...
    function handleCreateHabit() {
        if (habitInput === undefined || frequencyInput === undefined) {
            Alert.alert("OneBitLife","Você precisa selecionar um hábito e/ou frequência para continuar");
        } else if (
          ...
          Alert.alert("OneBitLife","Você precisa dizer o horário da notificação!");
        } else if (
            notificationToggle === true &&
            frequencyInput === "Diário" &&
